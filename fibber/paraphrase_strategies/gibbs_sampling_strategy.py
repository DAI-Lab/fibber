...
class GibbsSamplingStrategy(StrategyBase):

    def __init__(self, FLAGS, measurement_bundle):
        """Initialize the strategy."""
        super(GibbsSamplingStrategy, self).__init__(FLAGS, measurement_bundle)
    ...
    def fit(self, trainset):
        ...
        logger.info("Load bert language model for GibbsSamplingStrategy.")
